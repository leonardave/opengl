...
#define TEXTURE_LEVEL_1 1
#define TEXTURE_LEVEL_2 2
...
void drawImage(void)
{
    ...
    glTexImage2D(GL_TEXTURE_2D,TEXTURE_LEVEL_0, GL_RGB, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, imgBuf);
    glUniform1i(texUnitIndex,TEXTURE_LEVEL_0);//设置纹理单元索引
...
{
    shaderLoader.load("/Users/wistoneqqx/Documents/github/sbxfc/OpenGLTextureMapping/draw-triangle/Demo/simpleShader.vert",
                      "/Users/wistoneqqx/Documents/github/sbxfc/OpenGLTextureMapping/draw-triangle/Demo/simpleShader.frag");
    shaderLoader.bind();
}
...
int main(void)
{
    if(false == LoadImg("/Users/wistoneqqx/Documents/github/sbxfc/OpenGLTextureMapping/draw-triangle/Demo/test1.jpg")){
        printf("加载图片失败！\n");
    }
